...
--
-- Хост: 127.0.0.1:3307
-- Время создания: Ноя 07 2020 г., 14:02
...
(11, '', '5', 1),
(39, '8p0blb74jb8u943it9t71cpbts03ute6', '8', 4),
(40, '8p0blb74jb8u943it9t71cpbts03ute6', '1', 1),
...
(2, '2.jpg', 210881, 43, 'Rolls-royce_green', 'Максимальная скорость	250 км/ч (ограничена)\r\nРазгон 0-100 км/ч	4,9 с', 28000),
...
(8, '19qM.gif', 1030028, 157, 'Ferrari_red', '490 л.с.\r\n4.3 л.', 13000);
...
(2, 'user1', '$2y$10$xQErKtsnXfGQdzJ7gY1W5eI1HJWr.8pb32pxFQ1sTZPocNhdHN4uy', '8730069265fa67e0aa7bff9.03095390');
...
--
ALTER TABLE `cart`
  MODIFY `id_cartRecord` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT для таблицы `feedback`
--
ALTER TABLE `feedback`
  MODIFY `id_feedback` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
